...
public class EventsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        list.add(new Events(R.drawable.ic_dramatics,R.color.insta,"Dramatics","\u20B9 92,000"));
        ...
        list.add(new Events(R.drawable.ic_vocals,R.color.colorPrimaryDark,"Vocals","\u20B9 58,600"));
